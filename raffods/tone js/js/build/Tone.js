...
!function(t, e) {
    ...
    var t = {
        ...
        474: t => {
            t.exports = function(t, e) {
                ...
                if (null != s) {
                    var n, i, o, r, a = [], c = !0, h = !1;
                    try {
                        if (o = (s = s.call(t)).next,
                        0 === e) {
                            if (Object(s) !== s)
                                return;
                            c = !1
                        } else
                            for (; !(c = (n = o.call(s)).done) && (a.push(n.value),
                            a.length !== e); c = !0)
                                ;
                    } catch (t) {
                        h = !0,
                  ...
                  , T = function() {
                    return n((function t(e) {
                        ...
                        value: function(t) {
                            ...
                            if (m(t) || g(t)) {
                                ...
                                m(t)) {
                                    ...
                                    if (void 0 !== c && b(c) && this._automationEvents.push(r(this.getValue(e), e)),
                                    void 0 !== c && d(c) && c.startTime + c.duration > e) {
                                        var T = e - c.startTime
                                ...
                                if (-1 === M)
                                    ...
                                    if (d(t) && e + t.duration > v(this._automationEvents[M]))
                                        return !1;
                        ...
                        value: function(t) {
                            ...
                            if (e > 1) {
                                var s = this._automationEvents.slice(e - 1)
                                  , n = s[0];
                                b(n) && s.unshift(r(f(this._automationEvents, e - 2, n.startTime, this._defaultValue), n.startTime)),
                        ...
                        value: function(t) {
                            ...
                            if (void 0 !== o && b(o) && (void 0 === n || !u(n) || n.insertTime > t))
                                return c(t, f(this._automationEvents, i - 1, o.startTime, this._defaultValue), o);
                            if (void 0 !== o && p(o) && (void 0 === n || !u(n)))
                                return o.value;
                            if (void 0 !== o && d(o) && (void 0 === n || !u(n) || o.startTime + o.duration > t))
                                return t < o.startTime + o.duration ? w(t, o) : o.values[o.values.length - 1];
    ...
    return ( () => {
        ...
        const r = new WeakSet
          ...
          , Z = (t, [e,s,n], i) => {
            const o = t.get(e);
            void 0 === o ? t.set(e, new Set([[s, n]])) : G(o, [s, n], (t => t[0] === s), i)
        }
          , X = t => "inputs"in t
          , Y = (t, e, s, n) => {
            if (X(e)) {
          ...
          , ht = (t, e, s, n) => {
            ...
            null !== i && (H(t, i),
            !o || e || st(t) || tt(t).disconnect(et(s), n))
        }
        ;
        class lt {
            constructor(t) {
        ...
        const dt = (t, e, s, n, i) => {
          ...
          , zt = (t, e) => (t.connect = e.connect.bind(e),
        ...
        const Qt = (t, e, s, n) => t.createScriptProcessor(e, s, n)
          ...
          , ee = (t, e, s) => void 0 === t.copyFromChannel ? t.getChannelData(s)[0] : (t.copyFromChannel(e, s),
        e[0])
          , se = t => {
            if (null === t)
                return !1;
        ...
        (t, e) => {
            ...
            try {
                const s = e();
                return s instanceof Promise ? (ve.set(t, s),
                s.catch(( () => !1)).then((e => (ve.delete(t),
                ye.set(t, e),
                e)))) : (ye.set(t, s),
                s)
            } catch {
        ...
        const Ce = (t => null === t ? null : t.hasOwnProperty("OfflineAudioContext") ? t.OfflineAudioContext : t.hasOwnProperty("webkitOfflineAudioContext") ? t.webkitOfflineAudioContext : null)(xe)
          ...
          , Ve = ( (t, e, s, n, i, o, r, a, h, l, u, d, f, _, m, g) => class extends l {
            ...
            connect(t, s=0, a=0) {
                ...
                const p = et(t);
                if ("playbackRate" === p.name && 1024 === p.maxValue)
                    throw r();
                try {
                ...
                if (( (t, e, s, n) => {
                    ...
                    ;
                    return !!G(r, [e, s], (t => t[0] === e && t[1] === s), !0) && (a.add(c),
            ...
            disconnect(t, e, s) {
                ...
                if (void 0 === t)
                    ...
                    if (n = ( (t, e, s, n, i) => {
                        const o = j(t);
                        return Array.from(o.outputs).filter((t => !(t[0] !== s || void 0 !== n && t[1] !== n || void 0 !== i && t[2] !== i))).map((s => (U(s) ? ct(t, e, ...s) : ht(t, e, ...s),
                        o.outputs.delete(s),
                        s[0])))
                    }
                    )(this, c, t, e, s),
        ...
        (t, e, s) => {
            ...
            return (f, _, m, g, v) => {
                ...
                ;
                return !!h(w, [_, m, g], (t => t[0] === _ && t[1] === m && t[2] === g), !0) && (b.add(S),
          ...
          , Je = ( (t, e, s, n, i, r, a, c, h, l, u, p, d) => (n, f, _, m=null, g=null) => {
            const v = _.value
              ...
              , w = {
                ...
                set value(t) {
                    _.value = t,
                    w.setValueAtTime(t, n.context.currentTime)
                },
                ...
                cancelScheduledValues: t => (null === x && y.flush(n.context.currentTime),
                y.add(r(t)),
                _.cancelScheduledValues(t),
                w),
                exponentialRampToValueAtTime(t, e) {
                    ...
                    return null === x && y.flush(s),
                    0 === Array.from(y).length && (y.add(l(v, s)),
                    _.setValueAtTime(v, s)),
                    y.add(a(t, e)),
                ...
                setTargetAtTime: (t, e, s) => (null === x && y.flush(n.context.currentTime),
                y.add(h(t, e, s)),
                _.setTargetAtTime(t, e, s),
                w),
                setValueAtTime: (t, e) => (null === x && y.flush(n.context.currentTime),
                y.add(l(t, e)),
        ...
        const ts = ( (t, e, s, n, i, o, r, a) => class extends t {
            ...
            return {
                render(r, a) {
                    ...
                    return void 0 !== c ? Promise.resolve(c) : (async (r, a) => {
                        ...
                        await t(a, r.gain, c.gain)) : (await n(a, r.Q, c.Q),
          ...
          , os = ( (t, e) => (s, n, i) => {
            ...
            return s.connect = (i => (r, a=0, c=0) => {
                const h = 0 === o.size;
                if (e(r))
                    return i.call(s, r, a, c),
                    t(o, [r, a, c], (t => t[0] === r && t[1] === a && t[2] === c), !0),
                    h && n(),
                    r;
                i.call(s, r, a),
            ...
            s.disconnect = (t => (n, r, a) => {
                ...
                if (void 0 === n)
                    ...
                    for (const t of o)
                        t[0] !== n || void 0 !== r && t[1] !== r || void 0 !== a && t[2] !== a || o.delete(t)
                }
                const h = 0 === o.size;
                c && h && i()
            }
            ...
            return {
                render(r, a) {
                    ...
                    return void 0 !== c ? Promise.resolve(c) : (async (r, a) => {
                        ...
                        return o.set(a, c),
                        h ? (await t(a, r.attack, c.attack),
                        await t(a, r.knee, c.knee),
                        await t(a, r.ratio, c.ratio),
                        await t(a, r.release, c.release),
                        await t(a, r.threshold, c.threshold)) : (await n(a, r.attack, c.attack),
                    ...
                    return void 0 !== u ? Promise.resolve(u) : (async (h, l) => {
                        ...
                        null !== u) {
                            if (null === c) {
                                ...
                                c = (async () => (await n(h, t, t.destination),
                                ( (t, e, s, n) => {
              ...
              , {forwardX: u, forwardY: p, forwardZ: d, positionX: f, positionY: _, positionZ: m, upX: g, upY: v, upZ: y} = void 0 === l.forwardX ? ( () => {
                ...
                const g = () => {
                    ...
                    t.onaudioprocess = ({inputBuffer: t}) => {
                        ...
                        e.some(( (t, e) => t !== _[e])) && (l.setOrientation(...e),
                        _ = e);
                        const s = [o(t, u, 6), o(t, u, 7), o(t, u, 8)];
                        s.some(( (t, e) => t !== m[e])) && (l.setPosition(...s),
                        m = s)
                    }
                    ,
                    p.connect(t)
                  ...
                  , x = (e, n, o) => {
                    ...
                    l.cancelAndHoldAtTime = (u = l.cancelAndHoldAtTime,
                    d ? () => {
                        throw i()
                    }
                    : (...t) => {
                    ...
                    l.cancelScheduledValues = (f = l.cancelScheduledValues,
                    d ? () => {
                        throw i()
                    }
                    : (...t) => {
                    ...
                    l.exponentialRampToValueAtTime = (_ = l.exponentialRampToValueAtTime,
                    d ? () => {
                        throw i()
                    }
                    : (...t) => {
                    ...
                    l.linearRampToValueAtTime = (m = l.linearRampToValueAtTime,
                    d ? () => {
                        throw i()
                    }
                    : (...t) => {
                    ...
                    l.setTargetAtTime = (v = l.setTargetAtTime,
                    d ? () => {
                        throw i()
                    }
                    : (...t) => {
                    ...
                    l.setValueAtTime = (y = l.setValueAtTime,
                    d ? () => {
                        throw i()
                    }
                    : (...t) => {
                    ...
                    l.setValueCurveAtTime = (x = l.setValueCurveAtTime,
                    d ? () => {
                        throw i()
                    }
                    : (...t) => {
            ...
            return {
                ...
                render(h, l) {
                    ...
                    return void 0 !== u ? Promise.resolve(u) : (async (h, l) => {
                        ...
                        return o.set(l, u),
                        p ? (await t(l, h.detune, u.detune),
                        await t(l, h.frequency, u.frequency)) : (await n(l, h.detune, u.detune),
          ...
          , js = ( (t, e, s, n, i, o, r) => (a, c) => {
            ...
            let u = null
              , p = !1;
            return r(h, "curve", (t => () => t.call(h)), (e => s => (e.call(h, s),
            p && (n(s) && null === u ? u = t(a, h) : n(s) || null === u || (u(),
            u = null)),
            s))),
            i(h, ( () => {
                p = !0,
          ...
          , Ls = ( (t, e, s, n, i, o, r, a, c, h) => (l, {coneInnerAngle: u, coneOuterAngle: p, coneOuterGain: d, distanceModel: f, maxDistance: _, orientationX: m, orientationY: g, orientationZ: v, panningModel: y, positionX: x, positionY: w, positionZ: b, refDistance: T, rolloffFactor: S, ...k}) => {
            ...
            V.onaudioprocess = ({inputBuffer: t}) => {
                ...
                s.some(( (t, e) => t !== j[e])) && (A.setPosition(...s),
                j = s)
            }
            ,
          ...
          , zs = (t => (e, s) => {
            ...
            return void 0 === n.orientationX ? t(e, s) : (qt(n, s),
            Ft(n, s, "orientationX"),
            Ft(n, s, "orientationY"),
            Ft(n, s, "orientationZ"),
            Ft(n, s, "positionX"),
            ...
            return {
                render(p, d) {
                    ...
                    return void 0 !== f ? Promise.resolve(f) : (async (p, d) => {
                        ...
                        return v ? (await t(d, p.orientationX, _.orientationX),
                        ...
                        await t(d, p.positionZ, _.positionZ)) : (await a(d, p.orientationX, _.orientationX),
          ...
          , sn = Js ? ( (t, e, s, n, i, o, r, a, c, h, l, u, p) => {
            ...
            return (_, m, g={
                ...
                return void 0 === b ? h.set(_, new Map([[m, S]])) : b.set(m, S),
                S.then(( () => {
                    const t = l.get(_);
          ...
          , pn = ( (t, e, s, n, i, o, r, a, c) => class extends t {
            constructor(t={}) {
                ...
                if (null === e)
                    throw n();
                if (!(t => void 0 === t || "number" == typeof t || "string" == typeof t && ("balanced" === t || "interactive" === t || "playback" === t))(t.latencyHint))
          ...
          , xn = ( (t, e, s, n, i, o, r, a, c, h, l, u, p) => (d, f, m, g) => {
            ...
            if (void 0 !== m.parameterDescriptors)
                for (const {defaultValue: t, maxValue: e, minValue: s, name: n} of m.parameterDescriptors) {
                    const i = o(d, {
                        channelCount: 1,
                        channelCountMode: "explicit",
                        channelInterpretation: "discrete",
            ...
            const U = ft(g.numberOfInputs, g.channelCount)
              ...
              , Q = void 0 === m.parameterDescriptors ? [] : m.parameterDescriptors.reduce(( (t, {name: e}) => ({
                ...t,
                [e]: new Float32Array(128)
            })), {});
            let Z = !0;
                ...
                if (null !== W) {
                    ...
                    for (let n = 0; n < C; n += 128) {
                        ...
                        try {
                            const t = U.map(( (t, e) => {
                                if (s[e].size > 0)
                                    return Y.set(e, C / 128),
                                    t;
                                const n = Y.get(e);
                                return void 0 === n ? [] : (t.every((t => t.every((t => 0 === t)))) && (1 === n ? Y.delete(e) : Y.set(e, n - 1)),
                                t)
                            }
                            ))
            ...
            p(N, ( () => {
                if (Z) {
                    K(),
                    g.numberOfOutputs > 0 && O.connect(D);
                    for (let t = 0, e = 0; t < g.numberOfOutputs; t += 1) {
                        const s = M[t];
                        for (let n = 0; n < v[t]; n += 1)
                            D.connect(s, e + n, n);
          ...
          , wn = ( (t, e, s, n, i) => (o, r, a, c, h, l) => {
            if (null !== a)
                try {
                    ...
                    e.removeEventListener = (u = e.removeEventListener,
                    (...t) => {
                        if ("processorerror" === t[0]) {
                            const e = n.get(t[1]);
          ...
          , Cn = ( (t, e, s, n, i, o, r, a) => (c, h) => s(c).render(c, h).then(( () => Promise.all(Array.from(n(h)).map((t => s(t).render(t, h)))))).then(( () => i(h))).then((s => ("function" != typeof s.copyFromChannel ? (r(s),
        q(s)) : e(o, ( () => o(s))) || a(s),
        t.add(s),
        s))))(je, ge, be, dn, Cs, E, Be, Ue)
        ...
        function Yn(t) {
            In(t) && Qn && !Zn && (Zn = !0,
            Kn("Events scheduled inside of scheduled callbacks should use the passed in scheduling time. See https://github.com/Tonejs/Tone.js/wiki/Accurate-Timing"))
        }
        let $n = console;
        function Hn(t) {
            $n = t
        ...
        class ii {
            constructor(t, e, s, n) {
                this._callback = t,
                this._type = e,
                this._minimumUpdateInterval = Math.max(128 / (n || 44100), .001),
            ...
            set updateInterval(t) {
                ...
                "worker" === this._type && (null === (e = this._worker) || void 0 === e || e.postMessage(1e3 * this._updateInterval))
            }
            get type() {
                return this._type
            }
        ...
        function li(t, ...e) {
            ...
            if (Pn(t) && Pn(s))
                for (const e in s)
                    hi(e, s[e]) ? t[e] = s[e] : Pn(s[e]) ? (t[e] || Object.assign(t, {
                        [e]: {}
                    }),
        ...
        class wi extends fi {
            ...
            add(t) {
                if (Bn(Reflect.has(t, "time"), "Timeline: events must have a time attribute"),
            ...
            cancel(t) {
                if (this._timeline.length > 1) {
                    ...
                    1 === this._timeline.length && gi(this._timeline[0].time, t) && (this._timeline = []);
                return this
            }
            cancelBefore(t) {
            ...
            _search(t, e="time") {
                ...
                for (; s < i; ) {
                    ...
                    if (yi(o[e], t)) {
                        for (let s = n; s < this._timeline.length && yi(this._timeline[s][e], t); s++)
                            n = s;
                        return n
                    }
                    if (vi(o[e], t) && mi(r[e], t))
                        return n;
                    mi(o[e], t) ? i = n : s = n + 1
                }
                return -1
        ...
        class Ai extends fi {
            ...
            off(t, e) {
                return t.split(/\W+/).forEach((t => {
                    if (In(this._events) && (this._events = {}),
        ...
        class Oi extends Ci {
            constructor() {
                ...
                s.context ? (this._context = s.context,
                this._latencyHint = (null === (t = arguments[0]) || void 0 === t ? void 0 : t.latencyHint) || "") : (this._context = function(t) {
                    return new pn(t)
                }({
            ...
            createAudioWorkletNode(t, e) {
                return function(t, e, s) {
                    return Bn(Fn(kn), "AudioWorkletNode only works in a secure context (https or localhost)"),
                    new (t instanceof (null == ti ? void 0 : ti.BaseAudioContext) ? null == ti ? void 0 : ti.AudioWorkletNode : kn)(t,e,s)
                }(this.rawContext, t, e)
            }
            addAudioWorkletModule(t) {
                return ni(this, void 0, void 0, (function*() {
                    Bn(Fn(this.rawContext.audioWorklet), "AudioWorkletNode is only available in a secure context (https or localhost)"),
            ...
            close() {
                return ni(this, void 0, void 0, (function*() {
                    var t;
                    ci(this._context) && "closed" !== this.state && !this._closeStarted && (this._closeStarted = !0,
        ...
        class qi extends Oi {
            constructor() {
                ...
                super({
                    clockSource: "offline",
                    context: ai(arguments[0]) ? arguments[0] : (t = arguments[0],
        ...
        let Fi = Ii;
        function Vi() {
            return Fi === Ii && ei && Ni(new Oi),
            Fi
        }
        function Ni(t, e=!1) {
            e && Fi.dispose(),
            Fi = ci(t) ? new Oi(t) : ai(t) ? new qi(t) : t
        }
        function Pi() {
            return Fi.resume()
        }
        ...
        class Qi extends fi {
            ...
            valueOf() {
                if (this._val instanceof Qi && this.fromType(this._val),
                In(this._val))
                    return this._noArg();
        ...
        class no extends eo {
            constructor() {
                ...
                Bn(Fn(t.param) && (oi(t.param) || t.param instanceof no), "param must be an AudioParam"); !oi(t.param); )
            ...
            _assertRange(t) {
                return Fn(this.maxValue) && Fn(this.minValue) && Un(t, this._fromType(this.minValue), this._fromType(this.maxValue)),
                t
            }
            _fromType(t) {
            ...
            cancelAndHoldAtTime(t) {
                ...
                return n && yi(n.time, e) ? i ? (this._param.cancelScheduledValues(i.time),
        ...
        class io extends eo {
            ...
            dispose() {
                return super.dispose(),
                Fn(this.input) && (this.input instanceof io ? this.input.dispose() : ri(this.input) && this.input.disconnect()),
                Fn(this.output) && (this.output instanceof io ? this.output.dispose() : ri(this.output) && this.output.disconnect()),
                this._internalChannels = [],
                this
            }
        }
        function oo(...t) {
            const e = t.shift();
            t.reduce(( (t, e) => (t instanceof io ? t.connect(e) : ri(t) && ro(t, e),
            e)), e)
        }
        function ro(t, e, s=0, n=0) {
            for (Bn(Fn(t), "Cannot connect from undefined node"),
            Bn(Fn(e), "Cannot connect to undefined node"),
            (e instanceof io || ri(e)) && Bn(e.numberOfInputs > 0, "Cannot connect to node with no inputs"),
            Bn(t.numberOfOutputs > 0, "Cannot connect from node with no outputs"); e instanceof io || e instanceof no; )
                Fn(e.input) && (e = e.input);
            for (; t instanceof io; )
                Fn(t.output) && (t = t.output);
        ...
        class lo extends io {
            ...
            _onended() {
                if (this.onended !== Ei && (this.onended(this),
                this.onended = Ei,
        ...
        function fo(t, e, s, n) {
            (e instanceof no || oi(e) || e instanceof po && e.override) && (e.cancelScheduledValues(0),
        ...
        class go extends eo {
            ...
            getTicksAtTime(t) {
                ...
                return this._state.forEachBetween(o.time, e + this.sampleTime, (t => {
                    ...
                    s && s.time >= o.time && (r = s.ticks,
                    e = s.time),
                    "started" === o.state && "started" !== t.state && (r += this.frequency.getTicksAtTime(t.time) - this.frequency.getTicksAtTime(e),
                    t.time !== i.time && (a = {
                        state: t.state,
                        time: t.time,
                        ticks: r
            ...
            getSecondsAtTime(t) {
                ...
                return this._state.forEachBetween(i.time, t + this.sampleTime, (t => {
                    ...
                    n && n.time >= i.time && (o = n.seconds,
                    e = n.time),
                    "started" === i.state && "started" !== t.state && (o += t.time - e,
                    t.time !== s.time && (r = {
                        state: t.state,
                        time: t.time,
                        seconds: o
        ...
        class So extends fi {
            ...
            add(t, e, s=Ei, n=Ei) {
                return zn(e) ? (this.baseUrl && "data:audio/" === e.trim().substring(0, 11).toLowerCase() && (this.baseUrl = ""),
                this._buffers.set(t.toString(), new Ri(this.baseUrl + e,s,n))) : this._buffers.set(t.toString(), new Ri(e,s,n)),
                this
            }
            dispose() {
                return super.dispose(),
        ...
        class Io extends qo {
            ...
            set oversample(t) {
                Bn(["none", "2x", "4x"].some((e => e.includes(t))), "oversampling must be either 'none', '2x', or '4x'"),
        ...
        class Fo extends qo {
            constructor() {
                ...
                super(t),
                this.name = "Pow",
                this._exponentScaler = this.input = this.output = new Io({
                    context: this.context,
        ...
        class No extends Vo {
            ...
            _createEvents(t) {
                vi(this._nextTick + this._interval, this.floatTime + this.duration) && (this._nextTick += this._interval,
                this._currentId = this._nextId,
                this._nextId = this.transport.scheduleOnce(this.invoke.bind(this), new Co(this.context,this._nextTick).toSeconds()))
            }
            _restart(t) {
        ...
        class Po extends eo {
            ...
            unsyncSignal(t) {
                for (let e = this._syncedSignals.length - 1; e >= 0; e--) {
                    ...
                    s.signal === t && (s.nodes.forEach((t => t.dispose())),
        ...
        class jo extends io {
            constructor(t) {
                ...
                this._volume = this.output = new xo({
                    context: this.context,
                    mute: t.mute,
                    volume: t.volume
                }),
            ...
            start(t, e, s) {
                ...
                this._synced || "started" !== this._state.getValueAtTime(n))
                    ...
                    this._synced) {
                        ...
                        t && (t.offset = this.toSeconds(pi(e, 0)),
                    ...
                    Bn(mi(n, this._state.get(n).time), "Start time must be strictly greater than previous start time"),
            ...
            stop(t) {
                ...
                "started" === this._state.getValueAtTime(e) || Fn(this._state.getNextState("started", e))) {
                    if (this.log("stop", e),
                    this._synced) {
        ...
        class Lo extends lo {
            ...
            start(t, e, s, n=1) {
                ...
                vi(o, this.buffer.duration) && (this._sourceStarted = !0,
        ...
        class zo extends jo {
            ...
            set type(t) {
                if (Bn(t in Uo, "Noise: invalid type: " + t),
        ...
        class Go extends io {
            ...
            open(t) {
                return ni(this, void 0, void 0, (function*() {
                    ...
                    Nn(t) ? this._device = e[t] : (this._device = e.find((e => e.label === t || e.deviceId === t)),
        ...
        class Jo extends jo {
            constructor() {
                ...
                Di(this, ["modulationIndex", "frequency", "detune", "harmonicity"])
            }
            static getDefaults() {
                return Object.assign(Xo.getDefaults(), {
                    harmonicity: 1,
        ...
        class ar extends io {
            ...
            connect(t, e, s) {
                return (t instanceof no || t instanceof po) && (this.convert = t.convert,
                this.units = t.units),
                fo(this, t, e, s),
                this
            }
        ...
        class lr extends jo {
            ...
            _start(t, e, s) {
                ...
                this._loop && In(i) ? r.start(t, n) : r.start(t, n, o - this.toSeconds(this.fadeOut))
            }
            _stop(t) {
                const e = this.toSeconds(t);
            ...
            _restart(t, e, s) {
                var n;
                null === (n = [...this._activeSources].pop()) || void 0 === n || n.stop(t),
                this._start(t, e, s)
            }
            seek(t, e) {
                const s = this.toSeconds(e);
        ...
        class ur extends io {
            ...
            player(t) {
                if (Bn(this.has(t), `No Player with the name ${t} exists on this object`),
                !this._players.has(t)) {
                    const e = new lr({
                        context: this.context,
                        fadeIn: this._fadeIn,
        ...
        class gr extends qo {
            constructor() {
                ...
                this._thresh = this.output = new Io({
                    context: this.context,
                    length: 127,
                    mapping: t => t <= 0 ? 0 : 1
                }),
        ...
        class vr extends po {
            constructor() {
                ...
                this.override = !1,
                this._subtract = this.input = new mr({
                    context: this.context,
                    value: t.value
                }),
        ...
        class wr extends io {
            ...
            triggerRelease(t) {
                ...
                if (e > 0) {
                    ...
                    s < this.sampleTime ? this._sig.setValueAtTime(0, t) : "linear" === this._releaseCurve ? this._sig.linearRampTo(0, s, t) : "exponential" === this._releaseCurve ? this._sig.targetRampTo(0, s, t) : (Bn(Ln(this._releaseCurve), "releaseCurve must be either 'linear', 'exponential' or an array"),
                    this._sig.cancelAndHoldAtTime(t),
        ...
        const br = ( () => {
            ...
            const o = [];
            for (e = 0; e < t; e++)
                o[e] = Math.ceil(e / 127 * 5) / 5;
            const r = [];
            for (e = 0; e < t; e++)
                s = e / 127,
                r[e] = .5 * (1 - Math.cos(Math.PI * s));
            const a = [];
            for (e = 0; e < t; e++) {
                s = e / 127;
        ...
        class kr extends wr {
            constructor() {
                super(ui(kr.getDefaults(), arguments, ["attack", "decay", "sustain", "release"])),
        ...
        class Dr extends io {
            ...
            set type(t) {
                Bn(-1 !== ["lowpass", "highpass", "bandpass", "lowshelf", "highshelf", "notch", "allpass", "peaking"].indexOf(t), `Invalid filter type: ${t}`),
                this._filter.type = t
            }
        ...
        class Rr extends Sr {
            constructor() {
                ...
                super(t),
                this.name = "MonoSynth",
                this.oscillator = new nr(Object.assign(t.oscillator, {
                    context: this.context,
                    detune: t.detune,
                    onstop: () => this.onsilence(this)
                })),
                ...
                Di(this, ["oscillator", "frequency", "detune", "filter", "filterEnvelope", "envelope"])
            }
            static getDefaults() {
                return Object.assign(Sr.getDefaults(), {
                    envelope: Object.assign(di(wr.getDefaults(), Object.keys(io.getDefaults())), {
        ...
        class qr extends Sr {
            constructor() {
                ...
                Di(this, ["voice0", "voice1", "frequency", "vibratoAmount", "vibratoRate"])
            }
            getLevelAtTime(t) {
                return t = this.toSeconds(t),
        ...
        class Pr extends Tr {
            constructor() {
                ...
                this.noise = new zo(Object.assign({
                    context: this.context
                }, t.noise)),
                this.envelope = new kr(Object.assign({
                    context: this.context
        ...
        class Qr extends io {
            constructor() {
                ...
                this._lowpass = this.input = new Gr({
                    context: this.context,
        ...
        class Xr extends Tr {
            ...
            _getNextAvailableVoice() {
                ...
                if (this._voices.length < this.maxPolyphony) {
                    ...
                    return Bn(t instanceof Sr, "Voice must extend Monophonic class"),
        ...
        class Yr extends Tr {
            constructor() {
                ...
                Object.keys(t.urls).forEach((s => {
                    ...
                    if (Bn(Wn(s) || Nn(n) && isFinite(n), `url key is neither a note or midi pitch: ${s}`),
                    Wn(s)) {
                        const n = new Yi(this.context,s).toMidi();
                        e[n] = t.urls[s]
                    } else
                        Nn(n) && isFinite(n) && (e[n] = t.urls[n])
                }
                )),
                this._buffers = new So({
                    urls: e,
            ...
            triggerAttackRelease(t, e, s, n=1) {
                const i = this.toSeconds(s);
                return this.triggerAttack(t, i, n),
                Ln(e) ? (Bn(Ln(t), "notes must be an array when duration is array"),
                t.forEach(( (t, s) => {
                    const n = e[Math.min(s, e.length - 1)];
            ...
            add(t, e, s) {
                if (Bn(Wn(t) || isFinite(t), `note must be a pitch or midi: ${t}`),
                Wn(t)) {
                ...
                this._state.forEachFrom(t, (t => {
                    ...
                    if ("started" === t.state) {
                        ...
                        if (!0 === this._loop || Nn(this._loop) && this._loop > 1) {
                            ...
                            t.id = this.context.transport.schedule(this._tick.bind(this), new Co(this.context,s))
                    }
                }
                ))
            }
        ...
        class Jr extends $r {
            ...
            _startNote(t, e, s) {
                ...
                t.start(new Co(this.context,e))) : t.startOffset < this._loopStart && t.startOffset >= s && (t.loop = !1,
                t.start(new Co(this.context,e))) : t.startOffset >= s && t.start(new Co(this.context,e))
            }
            get startOffset() {
                return this._startOffset
            }
            ...
            at(t, e) {
                ...
                for (; !o.done; ) {
                    ...
                    if (Math.abs(s - t.startOffset) < n)
                        return Fn(e) && (t.value = e),
                        t;
                    o = i.next()
                }
                return Fn(e) ? (this.add(t, e),
                this.at(t)) : null
            }
            add(t, e) {
                ...
                const s = this.toTicks(t);
                let n;
                return e instanceof $r ? (n = e,
                n.callback = this._tick.bind(this)) : n = new $r({
                    callback: this._tick.bind(this),
                    context: this.context,
                    value: e
                }),
            ...
            remove(t, e) {
                ...
                this._events.forEach((s => {
                    s.startOffset === t && (In(e) || Fn(e) && s.value === e) && (this._events.delete(s),
                    s.dispose())
                }
                )),
                this
        ...
        function *ra(t, e="up", s=0) {
            switch (Bn(t >= 1, "The number of values must be at least one"),
            e) {
            case "up":
                yield*ea(t, Kr);
            case "down":
        ...
        class ca extends $r {
            ...
            _createSequence(t) {
                return new Proxy(t,{
                    get: (t, e) => t[e],
                    set: (t, e, s) => (zn(e) && isFinite(parseInt(e, 10)) && Ln(s) ? t[e] = this._createSequence(s) : t[e] = s,
                    this._eventsUpdated(),
                    !0)
                })
            }
        ...
        class Ta extends io {
            constructor(t) {
                ...
                this._dryWet = this.output = new ha({
                    context: this.context,
                    fade: t.wet
                }),
                this.wet = this._dryWet.fade,
        ...
        class qa extends Ta {
            constructor() {
                ...
                this._combFilters = Ea.map(( (e, s) => {
                    ...
                    return s < Ea.length / 2 ? this.connectEffectLeft(n, ...this._allpassFiltersL) : this.connectEffectRight(n, ...this._allpassFiltersR),
        ...
        class Na extends Ta {
            constructor() {
                ...
                this._feedbackCombFilters = Ia.map(( (t, e) => {
                    ...
                    e < Ia.length / 2 ? this.connectEffectLeft(...this._allpassFilters, s) : this.connectEffectRight(...this._allpassFilters, s),
                    s
                }
                )),
        ...
        class La extends Ca {
            ...
            set pitch(t) {
                ...
                e = zi(t - 1) + 1) : (this._lfoA.min = this._windowSize,
                this._lfoA.max = 0,
        ...
        class $a extends io {
            constructor() {
                ...
                this.name = "MeterBase",
                this.input = this.output = this._analyser = new Ya({
                    context: this.context,
                    size: 256,
                    type: "waveform"
                })
        ...
        class ec extends io {
            constructor() {
                ...
                ec._allSolos.has(this.context) || ec._allSolos.set(this.context, new Set),
            ...
            _addSolo() {
                ec._soloed.has(this.context) || ec._soloed.set(this.context, new Set),
        ...
        class sc extends io {
            constructor() {
                ...
                super(t),
                this.name = "PanVol",
                this._panner = this.input = new da({
                    context: this.context,
                    pan: t.pan,
                    channelCount: t.channelCount
                }),
        ...
        class ac extends io {
            ...
            start() {
                return ni(this, void 0, void 0, (function*() {
                    ...
                    return "stopped" === this.state ? this._recorder.start() : this._recorder.resume(),
                    yield t
                }
                ))
            }
        ...
        class uc extends io {
            constructor() {
                ...
                this._midSideSplit = this.input = new Ba({
                    context: this.context
                }),
        ...
        class pc extends io {
            constructor() {
                ...
                this._splitter = this.input = new oc({
                    context: this.context,
        ...
        class dc extends io {
            constructor() {
                ...
                this._internalChannels = [],
                this.input = this._multibandSplit = new oc({
                    context: this.context,
                    highFrequency: t.highFrequency,
                    lowFrequency: t.lowFrequency
                }),
